...
const SHOTS: Record<ShotName, Shot> = {
  tools: {
    ...
    shiftY: -0.014,
    shiftX: 0.026,
    portrait: { dist: 0.42, elev: 28, azim: -28, shiftY: 0.014, shiftX: 0 },
  },
  core: {
    subject: 'nail',
    dist: 0.235,
    ...
    shiftY: 0.002,
    shiftX: 0.016,
    portrait: { dist: 0.27, elev: 15, azim: -26, shiftY: 0.014, shiftX: 0 },
  },
  petals: {
    subject: 'nail',
    dist: 0.265,
    ...
    shiftY: -0.004,
    shiftX: 0.024,
    portrait: { dist: 0.3, elev: 28, azim: -30, shiftY: 0.012, shiftX: 0 },
  },
  transfer: {
    subject: 'between',
    dist: 0.44,
    ...
    shiftY: -0.006,
    shiftX: 0,
    portrait: { dist: 0.54, elev: 29, azim: -34, shiftY: 0.002, shiftX: 0 },
  },
  finish: {
    subject: 'cake',
    dist: 0.36,
