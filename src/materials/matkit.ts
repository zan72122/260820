...
export function createMatKit(reg: TextureRegistry): MatKit {
  ...
  return {
    ...
    bark: makeMat(reg, 'bark', { repeat: rep('bark'), vertexColors: true }),
...
export function createStubMatKit(): MatKit {
  ...
  return {
    ...
    plaster: m('#e3dcca', { vertexColors: true }),
    kawara: m('#4d525a', { vertexColors: true }),
    stone: m('#8f8a80', { vertexColors: true }),
    soilTilled: m('#4a3a29'),
    gravel: m('#7b756c'),
    moss: m('#556334'),
    bark: m('#4c4238', { vertexColors: true }),
    bamboo: m('#b5a05d', { vertexColors: true }),
    paperShoji: m('#f6f0e1'),
    metalTin: m('#9aa1a4', { vertexColors: true }),
    grassShort: m('#66702f'),
    shadowWood: m('#16130f'),
  }
}
