...
// The ring stands on a single thin pin (a narrow tick below the bowl); the
// tail is tied to the ring by a ray-aligned strut at the rim crossing and
// leans on an inclined brace that lives in the plane of light rays through
// the tail line — its shadow prolongs the tail straight off the screen.
...
export const letterQ: LetterSpec = {
  ...
  braces: [
    ...
    { a: [0.5, 0.88], za: 3.22, b: [1.738, -0.283], zb: 3.1, r: 0.009 },
  ],
  lightY: 1.5,
  tableAngle0: 0.75,
