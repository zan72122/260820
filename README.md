...
- **強い吸着補正** — シュートの狙いがずれても、雪の初速を弾道解に寄せ、飛行中も水平方向だけ
  軽く誘導して荷台に入ります（放物線は放物線のまま。`src/main.js` の `emitSnow`）。
  シュートを変な向きで放置しても、4秒後にゆっくり自動で戻るので詰みません。
